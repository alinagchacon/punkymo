...
<figure><img src="../.gitbook/assets/image (858).png" alt="" width="563"><figcaption><p>Dirección IP de la VM donde tengo instalado Suricata</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (860).png" alt="" width="430"><figcaption><p>Detalle de la configuración de /etc/suricata/suricata.yml</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (861).png" alt=""><figcaption><p>Suricata en ejecución</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (862).png" alt=""><figcaption><p>tail -f /var/log/suricata/suricata.log</p></figcaption></figure>
...
<mark style="color:orange;">Esto emitirá una alerta sobre cualquier tráfico IP que contenga el contenido en su carga útil. Esta regla se puede activar fácilmente pero antes de hacerlo, iniciamos</mark> <mark style="color:orange;">`tail`</mark> <mark style="color:orange;">para ver las actualizaciones de</mark> <mark style="color:orange;">`fast.log`</mark><mark style="color:orange;">.</mark>
...
<figure><img src="../.gitbook/assets/image (876).png" alt=""><figcaption><p>prometheus se encuentra en escucha por el puerto 9090</p></figcaption></figure>

Por tanto, si tengo la VM en modo adaptador puente, puedo acceder al servicio a través de:

<figure><img src="../.gitbook/assets/image (877).png" alt="" width="563"><figcaption><p>Panel de Prometheus</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (878).png" alt=""><figcaption><p>Comprobamos que tenemos el servicio node_exporter escuchando por el puerto 9100</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (879).png" alt=""><figcaption><p>Grafana por el puerto 3000</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/image (880).png" alt=""><figcaption><p>Dashboard de grafana</p></figcaption></figure>
