...
<figure><img src="../../../.gitbook/assets/image (5).png" alt=""><figcaption><p>Configurando VLANs</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (4).png" alt=""><figcaption><p>Configurando los PC</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (6).png" alt=""><figcaption><p>COnfiguración en el router</p></figcaption></figure>

Si ponemos el comando `show vlan brief` en el swich SW-1 veremos algo como lo siguiente:

<figure><img src="../../../.gitbook/assets/image (7).png" alt=""><figcaption><p>Configuración de VLAN en un switch</p></figcaption></figure>

Si escribimos `show interfaces trunk` en el mismo switch, veremos:

<figure><img src="../../../.gitbook/assets/image (8).png" alt=""><figcaption><p>Configuración del enlace troncal en un switch</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (9).png" alt=""><figcaption><p>Haciendo ping al servidor externo a la red que tiene IP 8.8.8.8</p></figcaption></figure>
...
<figure><img src="../../../.gitbook/assets/image (10).png" alt=""><figcaption><p>Pool de DHCP en el Router</p></figcaption></figure>
