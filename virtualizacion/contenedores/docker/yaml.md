...
Está inspirado en lenguajes del tipo XML, C, Python y Perl, así como en el formato de los [correos electrónicos](https://es.wikipedia.org/wiki/Correo_electr%C3%B3nico).
